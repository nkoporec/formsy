<form method="POST" action="{{ route('handler-form', ['form_id' => formsy_get_form(), 'handler' => 'gmail']) }}">
    @csrf
    <div class="flex bg-white overflow-hidden font-sans text-formsydark flex-col">
        <div class="w-full px-8 pt-6 pb-8 mb-4 bg-white rounded flex">
            <div class="w-2/12 border-r pl-5 pr-10 hidden lg:block">
                <img src="{{URL::asset('/images/handlers/gmail-logo.png')}}" alt="Gmail" class="pt-20"/>
            </div>
            <div class="w-10/12 pl-10 pt-5">
                <div class="mb-4 flex">
                    @if (formsy_handler_get_setting('gmail', 'enabled'))
                        <x-forms.checkbox
                            name="enabled"
                            id="enabled"
                            label="Enable"
                ...
                <div class="mb-4">
                    <x-forms.email
                        ...
                        id="username"
                        label="Username"
                        value="{{ formsy_handler_get_setting('gmail', 'username') }}"
                        required="true"
                    />
                </div>
                <div class="mb-4">
                    <x-forms.password
                        ...
                        id="password"
                        label="App Password"
                        value="{{ formsy_handler_get_setting('gmail', 'password') }}"
                        required="true"
                    />
                </div>
            </div>
            ...
            <div class='w-full px-8 pt-6 pb-8 mb-4 bg-white rounded'>
                <div class="mb-4">
                    <x-forms.textfield
                        ...
                        id="recipients"
                        label="Recipients"
                        value="{{ formsy_handler_get_setting('gmail', 'recipients') }}"
                        required="true"
                    />
                </div>
                <div class="mb-4">
                    <x-forms.textfield
                        ...
                        id="from_email"
                        label="From email"
                        value="{{ formsy_handler_get_setting('gmail', 'from_email') }}"
                        required="true"
                    />
                </div>
                <div class="mb-4">
                    <x-forms.textfield
                        ...
                        id="from_name"
                        label="From name"
                        value="{{formsy_handler_get_setting('gmail', 'from_name')}}"
                        required="true"
                    />
                </div>
                <div class="mb-4">
                    <x-forms.textfield
                        ...
                        id="subject"
                        label="Subject"
                        value="{{ formsy_handler_get_setting('gmail', 'subject') }} "
                        required="true"
                    />
                </div>
                <div class="mb-10">
                    <x-forms.textarea
                        ...
                        id="email_body"
                        label="Email"
                        value="{{ formsy_handler_get_setting('gmail', 'email_body') }} "
                        required="true"
        ...
        <div class="w-full pl-4">
            @foreach (formsy_form_get_conditionals('gmail') as $key => $condition)
